...
WorldVoice - это многоязычное приложение для читателя экрана NVDA, которое поддерживает пять языковых синтезаторов (Espeak, OneCore, RHVoice, SAPI5, Piper) и предоставляет разнообразные возможности их настройки. Пользователи могут подстраивать свои настройки под различные контексты, максимально удовлетворяя свои потребности.
...
В дополнение к общим шагам установки приложения NVDA, если вы хотите использовать голоса aisound, вам необходимо установить пакеты с ядром. Если вы хотите использовать голоса RHVoice, вам необходимо установить пакеты с этими голосами.
...
Синтезатор речи: вы можете выбрать синтезаторы, которые будут включены.
