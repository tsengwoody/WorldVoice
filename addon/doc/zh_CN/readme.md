...
*	修正 aisound 音量回避 bug
*	修正 VE 遇 utf8 4bit 字符会让后续文字不朗读的问题
*	修正 VE 遇 unicode utf8 编码错误时文字不朗读的问题
*	在语音设定新增引擎分类，可选择要启用的语音引擎，默认为 VE, OneCore, aisound
*	兼容于 NVDA 版本 2023.1
