...
class SynthDriver(synthDriverHandler.SynthDriver):
    ...
    def _get_voices_and_variants(self):
        ...
        for voice in self.voices:
            ...
            lang = languageHandler.normalizeLanguage(voice.language)
            ...
            name = voice.name
            langDescription = languageHandler.getLanguageDescription(lang)
            WV_data.append({
                "id": voice_id,
                "name": name,
                "locale": lang,
        ...
        return all_voices, all_variants, default_variants, WV_data
